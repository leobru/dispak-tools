        ...
        if ((Bits(NEOP) + Bits(EQOP) + Bits(LTOP) + Bits(GEOP) +
            ...
            if (arg1Const and arg2Const) {
                ...
                case IDIVROP:    arg1Val.r = (double)arg1Val.i / (double)arg2Val.i;
                    break;
                case MKRANGE:    arg1Val.m = BitRange(arg1Val.i,arg2Val.i);
                    break;
                case SETSUB:
                    goto L10075;
                case NEOP: case EQOP: case LTOP: case GEOP: case GTOP: case LEOP: case INOP:
                case badop27: case badop30: case badop31: case ASSIGNOP:
                    error(200);
                    break;
                default:
                    break;
...
// Patch the last instruction
                if (putLeft)
                    objBuffer[objBufIdx-1] =
                        objBuffer[objBufIdx-1] &~ (Bits(28) - BitRange(30,35)).val |
                        (unused85z.m * (Bits(28)+BitRange(30,35))).val;
                else {
                    unused85z.m = unused85z.m * (Bits(28)+BitRange(30,35));
                    unused85z.m = unused85z.m << 24;
                    leftInsn = leftInsn &~ (Bits(4)-BitRange(6,11)).val | unused85z.m.val;
                }
            }
        } break;
        case 17: { /* mapia */
